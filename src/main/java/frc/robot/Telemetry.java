...
public class Telemetry {
        ...
        private final DoublePublisher driveOdometryFrequency = driveStateTable.getDoubleTopic("OdometryFrequency")
                        .publish();
        private final DoublePublisher gyroYaw = driveStateTable.getDoubleTopic("Gyro Yaw")
                        .publish();
        private final DoublePublisher gyroPitch = driveStateTable.getDoubleTopic("Gyro Pitch")
                        .publish();
        private final DoublePublisher gyroRoll = driveStateTable.getDoubleTopic("Gyro Roll")
                        .publish();
        ...
        public void telemeterize(SwerveDriveState state) {
                ...
                gyroYaw.set(drivetrain.getPigeon2().getYaw().getValueAsDouble());
                gyroPitch.set(drivetrain.getPigeon2().getPitch().getValueAsDouble());
                gyroRoll.set(drivetrain.getPigeon2().getRoll().getValueAsDouble());
